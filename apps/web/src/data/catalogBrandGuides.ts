...
export const CATEGORY_BRAND_GUIDES: Record<string, GuideBrand[]> = {
  laminate: [
    ...
    },
    {
      ...
      slug: 'amadei',
      collections: [
        { name: 'Арфа 12.33', id: 'arfa-12-33', brand: 'arfa', collection: 'arfa' },
        {
          name: 'Валторна 12.33',
          id: 'valtorna-12-33',
          brand: 'valtorna',
        ...
        { name: 'Варган', id: 'vargan', brand: 'vargan', collection: 'vargan' },
        {
          name: 'Геликон 10.32',
          id: 'gelikon-10-32',
          brand: 'gelikon',
        ...
        { name: 'Домра', id: 'domra', brand: 'domra', collection: 'domra' },
        {
          name: 'Кастаньеты 10.33',
          id: 'kastanety-10-33',
          brand: 'kastanety',
          collection: 'kastanety',
        },
        {
          name: 'Кастаньеты 12.33',
          id: 'kastanety-12-33',
          brand: 'kastanety',
          collection: 'kastanety',
        },
        {
          name: 'Кастаньеты 8.32',
          id: 'kastanety-8-32',
          brand: 'kastanety',
          collection: 'kastanety',
        },
        {
          name: 'Кастаньеты 8.33',
          id: 'kastanety-8-33',
          brand: 'kastanety',
          collection: 'kastanety',
        },
        { name: 'Лира 8.33', id: 'lira-8-33', brand: 'lira', collection: 'lira' },
        { name: 'Литавры', id: 'litavry', brand: 'litavry', collection: 'litavry' },
        { name: 'Лютень 9.33', id: 'lyuten-9-33', brand: 'lyuten', collection: 'lyuten' },
        {
          name: 'Мелодика 8.32',
          id: 'melodika-8-32',
          brand: 'melodika',
        ...
        { name: 'Свирель 8.33', id: 'svirel-8-33', brand: 'svirel', collection: 'svirel' },
        {
          name: 'Фанфара 8.32',
          id: 'fanfara-8-32',
          brand: 'fanfara',
        ...
        { name: 'Цитра 10.33', id: 'tsitra-10-33', brand: 'tsitra', collection: 'tsitra' },
      ],
    },
  ],
  'quartzvinyl-spc': [
